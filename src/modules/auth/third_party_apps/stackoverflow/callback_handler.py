...
from .callback_helpers import exchange_so_token, fetch_so_user


async def stackoverflow_callback_handler(
    request: Request, redirect_uri: str, pg_manager: PostgresManager
) -> RedirectResponse:
    start = perf_counter()
