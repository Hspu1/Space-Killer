...
#
#
# async def get_user_id(user_info: dict, provider: str) -> str:
...
#         email_verification = datetime.now(
#             timezone.utc) if provider == "google" and user_info.get(
#             "email_verified") else datetime.now(timezone.utc)
#
#         if not user:
#             try:
...
#             print(f"GitHub returned error: {resp.text}")
#         user_info = resp.json()
#         print(user_info)
#
#         if not user_info.get('email'):
#             emails_resp = await github_oauth.github.get('user/emails',
#                                                         token=token)
...
#             user_id = await get_user_id(user_info=user_info, provider="github")
